...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b70458, const void *arg_0xb7b705f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b218c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79cb840), 
int (*key_eq_fn)(void *arg_0xb79cbc88, void *arg_0xb79cbe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb789a9b8, int arg_0xb789ab10);
static double RandomUniform(void );
...
typedef sensorState SmartBraceletC$FakeSensor$val_t;
...
bool SmartBraceletC$coupled[1000];
...
#line 259
static inline void SmartBraceletC$FakeSensor$readDone(error_t result, sensorState localState);
#line 300
static inline void SmartBraceletC$pairingSucc(void );
#line 331
static void SmartBraceletC$sendMessage(void );
...
#line 300
{
  ...
  if (!SmartBraceletC$busy[sim_node()] || 1) {
      ...
      if (SmartBraceletC$AMSend$send(SmartBraceletC$pairDevice[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t )) == SUCCESS) {
          ...
          sim_log_debug(171U, "Radio", "Radio: pairing confirmation sent to node %hhu\n", SmartBraceletC$pairDevice[sim_node()]);
          SmartBraceletC$busy[sim_node()] = TRUE;
        }
      else {
          sim_log_debug(172U, "Radio", "Error in sending confirmation packet\n");
          sim_log_debug(173U, "Radio", "Pair device is: %hu\n", SmartBraceletC$pairDevice[sim_node()]);
        }
    }
}
...
#line 166
{
  ...
  if (SmartBraceletC$AMPacket$destination(bufPtr) == AM_BROADCAST_ADDR) {
      if (strcmp(message->content, SmartBraceletC$key[sim_node()][TOS_NODE_ID]) == 0) {
          sim_log_debug(161U, "Radio", "Sending confirmation packet to the other mote\n");
    ...
    if (SmartBraceletC$AMPacket$destination(bufPtr) == TOS_NODE_ID && strcmp(message->content, "Pairing Message") == 0) {

        SmartBraceletC$phase[sim_node()] = 2;
        SmartBraceletC$PairingTimer$stop();

        if (SmartBraceletC$AMSend$send(SmartBraceletC$pairDevice[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t )) == SUCCESS) {
            sim_log_debug(162U, "Radio", "Radio: pairing complete, let's start sent to node %hhu\n", SmartBraceletC$pairDevice[sim_node()]);
          }
        else {
            sim_log_debug(163U, "Radio", "Error 189\n");
          }
      }
    else {
#line 193
      if (SmartBraceletC$AMPacket$destination(bufPtr) == TOS_NODE_ID && __nesc_ntoh_uint8(message->type.nxdata) == 3) {
          ...
          sim_log_debug(164U, "Radio_pack", "INFO message received\n");
          sim_log_debug(165U, "Info", "Position X: %hhu, Y: %hhu\n", __nesc_ntoh_uint16(message->X.nxdata), __nesc_ntoh_uint16(message->Y.nxdata));
          sim_log_debug(166U, "Info", "Sensor status: %s\n", message->content);
          ...
          if (strcmp(message->content, "FALLING") == 0) {
              sim_log_debug(167U, "Info", "ALERT: FALLING!\n");
            }
        }
      }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb763cac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb763cac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb763cac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74bd2b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74bd2b0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb763c108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb763c108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb763a178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb763a178, msg, payload, len);
#line 78
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74be8a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74be8a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74be8a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 259 "SmartBraceletC.nc"
static inline void SmartBraceletC$FakeSensor$readDone(error_t result, sensorState localState)
#line 259
{
  SmartBraceletC$state[sim_node()] = localState;
  sim_log_debug(168U, "Sensors", "Sensor status: %s\n", SmartBraceletC$state[sim_node()].stateName);
  sim_log_debug(169U, "Sensors", "Position X: %hhu, Y: %hhu\n", localState.X, localState.Y);
#line 288
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77f6650){
#line 75
  switch (arg_0xb77f6650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77f6650);
#line 75
      break;
#line 75
    }
...
#line 82
{
  ...
  if (!SmartBraceletC$busy[sim_node()] && !SmartBraceletC$coupled[sim_node()]) {
      sb_msg_t *message = (sb_msg_t *)SmartBraceletC$Packet$getPayload(&SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t ));
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb733d3a8){
#line 83
  switch (arg_0xb733d3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb733d3a8);
#line 83
      break;
#line 83
    }
  ...
  if (&SmartBraceletC$packet[sim_node()] == bufPtr && error == SUCCESS) {
      ...
      if (SmartBraceletC$phase[sim_node()] == 2) {
          ...
          if (TOS_NODE_ID % 2 == 0) {
              ...
              SmartBraceletC$coupled[sim_node()] = TRUE;
...
#line 331
{
  ...
  if (!SmartBraceletC$busy[sim_node()]) {
      ...
      if (SmartBraceletC$AMSend$send(SmartBraceletC$pairDevice[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t )) == SUCCESS) {
          sim_log_debug(174U, "Radio", "Radio: sending INFO packet to node %hhu\n", SmartBraceletC$pairDevice[sim_node()]);
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SmartBraceletC$coupled"))
  {
    *addr = (uintptr_t)&SmartBraceletC$coupled[__nesc_mote];
    *size = sizeof(SmartBraceletC$coupled[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  SmartBraceletC$coupled[__nesc_mote] = FALSE;
